...
/* USER CODE BEGIN EFP */
void set_ph6_servo_position(uint16_t angle);  // PH6 servo control function declaration
void set_pb15_servo_position(uint16_t angle); // PB15 servo control function declaration
/* USER CODE END EFP */
